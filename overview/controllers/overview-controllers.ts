...
export class CatsController {
  ...
  // To define routes with parameters, you can add route parameter tokens in the route 
  // path to capture the dynamic values from the URL.
  // The route parameter token in the @Get() decorator example below illustrates this
  // approach. These route parameters can then be accessed using the @Param() decorator
...
// The @Controller decorator can take a host option to require that the HTTP host of 
// the incoming requests matches some specific value.
